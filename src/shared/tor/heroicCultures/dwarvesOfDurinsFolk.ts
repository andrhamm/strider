...
export const HeroicCultureDwarvesOfDurinsFolk: HeroicCultureType = {
    ...
    skills: {
        ...
        table: [
            ...
            { skill: 'song', rank: 1 },
            { skill: 'craft', rank: 2, underlined: true },
            { skill: 'enhearten', rank: 0 },
            { skill: 'travel', rank: 3, underlined: true},
