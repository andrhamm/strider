import {
  AttributeKeySchema,
  CombatProficiencyKeySchema,
  CulturalBlessingKeySchema,
  CulturalHandicapKeySchema,
  DerivedStatKeySchema,
  DistinctiveFeatureKeySchema,
  HeroicCultureKeySchema,
  LanguageKeySchema,
  PageReferenceSchema,
  SkillKeySchema,
  StandardOfLivingKeySchema,
  TypicalNameTypeKeySchema
} from './keys'
...
const CulturalBlessingsSchema = z.object({
  ...
  culturalBlessings: z
    .record(CulturalBlessingKeySchema, CulturalBlessingSchema)
...
const CulturalHandicapsSchema = z.object({
  ...
  culturalHandicaps: z
    .record(CulturalHandicapKeySchema, CulturalHandicapSchema)
    .refine((obj): obj is Required<typeof obj> =>
...
const DerivedStatsTableSchema = z
  .array(
    z.object({
...
const HeroicCulturesSchema = z.object({
  ...
  heroicCultures: z
    .record(HeroicCultureKeySchema, HeroicCultureSchema)
    .refine((obj): obj is Required<typeof obj> =>
