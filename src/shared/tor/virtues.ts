...
const VirtuesSchema = z.object({
  ...
  virtues: z
    .record(VirtueKeySchema, VirtueSchema)
...
export const Virtues: VirtuesType = {
  ...
  virtues: {
    ...
    barukKhazad: {
      ...
      name: 'Baruk Khazâd!',
      cultures: ['dwarvesOfDurinsFolk', 'dwarvesOfNogrodAndBelegost'],
      minimumWisdom: 2
    },
    brokenSpells: {
      source: {
    ...
    ancientFire: {
      source: {
        pageReference: {
          textId: 'moria',
          pageNumber: 188 // TODO: alpha
        }
      },
      name: 'Ancient Fire',
      cultures: ['dwarvesOfNogrodAndBelegost'],
      minimumWisdom: 2
    },
    telcharsSecrets: {
      source: {
